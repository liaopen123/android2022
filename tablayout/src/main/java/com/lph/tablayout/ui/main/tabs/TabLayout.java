...
package com.lph.tablayout.ui.main.tabs;
  ...
  public final class TabView extends LinearLayout {
      ...
      this.iconView =
          (ImageView)
              LayoutInflater.from(getContext())
                  .inflate(com.lph.tablayout.R.layout.item_tablayout_tab_icon, iconViewParent, false);
    ...
    private void inflateAndAddDefaultTextView() {
      ...
      this.textView =
          (TextView)
              LayoutInflater.from(getContext())
                  .inflate(com.lph.tablayout.R.layout.item_tablayout_tab_text, textViewParent, false);
